...
# <a href="https://colab.research.google.com/github/anguelos/cv_ws_2023/blob/main/training_large.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>
...
train_preprocess = torchvision.transforms.Compose([
    ...
    torchvision.transforms.RandomResizedCrop((150,150), scale=(0.1, 1.0), ratio=(0.75, 1.3)),
...
# new_model.load(f"{experiment_name}.pt")
