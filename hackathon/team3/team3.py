...
train_preprocess = torchvision.transforms.Compose([
    ...
    torchvision.transforms.RandomResizedCrop((160,160), scale=(0.08, 1.0), ratio=(0.75, 1.3333333333333333)),
...
val_preprocess = torchvision.transforms.Compose([
    lambda x:x.convert("RGB"),
    torchvision.transforms.Resize(150),
    torchvision.transforms.CenterCrop((160,160)), #make sure, all the pictures are the same size
    torchvision.transforms.ToTensor(),
    torchvision.transforms.Normalize([0.5,0.5,0.5], [0.5,0.5,0.5])
])
